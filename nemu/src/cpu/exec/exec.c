...
opcode_entry opcode_table [512] = {
  ...
  /* 0x68 */	IDEX(I, push), IDEX(I_E2G, imul3), IDEXW(I, push, 1), IDEXW(I_E2G, imul3, 1),
  ...
  /* 0x20 */	IDEXW(CR, mov_CR2r, 4), EMPTY, IDEXW(CR, mov_r2CR, 4), EMPTY,
  ...
  /* 0xec */	IDEXW(in_dx2a,in,1), IDEX(in_dx2a,in), IDEXW(out_a2dx,out,1), IDEX(in_dx2a,out),
  /* 0xf0 */	EMPTY, EMPTY, EMPTY, EMPTY,
