...
opcode_entry opcode_table [512] = {
  ...
  /* 0x20 */	IDEXW(G2E,sub,1), IDEX(G2E,sub), IDEXW(E2G,sub,1),IDEX(E2G,sub),
  /* 0x24 */	IDEXW(I2a,sub,1), IDEX(I2a,sub), EMPTY, EMPTY,
  ...
  /* 0x84 */	EMPTY, IDEX(E2G, test), EMPTY, EMPTY,
  ...
  /* 0xb4 */	EMPTY, EMPTY, IDEX(G2E, movzx), IDEX(G2E, movzx),
